            ...
            <x-backend.addons.card-component cardTitle="create" :cardAddonButtons="$card_addon_buttons">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mt-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="relative">
                            <input wire:model.live="state.code" type="text" class="form-input ps-11" id="code">
                            <div class="absolute inset-y-0 start-4 flex items-center z-20">
                    ...
                    <div class="md:col-span-2">
                        ...
                        @else
                        <div class="text_help">{{ __('password required') }}</div>
                        @endif
                    </div>
                    <!-- /.col-span -->
                ...
                <div class="grid sm:flex flex-row-reverse items-center justify-between gap-3 mt-6 ihelp_card_footer">
                    <div class="flex items-center">
                        <input wire:model.live="state.is_active" class="form-switch" type="checkbox" id="is_active"
                            checked>
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <button wire:click.prevent="clear" wire:loading.class.remove="btn_reset" class="btn_reset"
                            wire:loading.class="btn_loading" wire:loading.attr="disabled">
                            <div wire:loading wire:target="clear" class="ihelp_loader_for_btn">
                                <span class="sr-only">Loading...</span>
                            </div>
                            <i class="{{ _icons('reset') }}" wire:loading.remove wire:target="clear"></i>
                            {{ __('reset') }}
                        </button>
